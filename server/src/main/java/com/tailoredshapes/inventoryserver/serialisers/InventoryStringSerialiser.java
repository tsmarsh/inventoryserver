...
public class InventoryStringSerialiser implements Serialiser<Inventory> {

  private final UrlBuilder<Inventory> inventoryUrlBuilder;
  private final Serialiser<Metric> metricSerializer;

  public InventoryStringSerialiser(UrlBuilder<Inventory> inventoryUrlBuilder,
                                   Serialiser<Metric> metricSerializer) {
