...
public interface Router {
    ...
    static void route(EntityManagerFactory emf) {
        ...
        post("/inventories", "application/json", (req, res) -> {
            Inventory saved = transactional(emf, (em) -> {
                ...
                return Repository.save(dao).save(inventory);
            });
        ...
        get("/users/:name", "application/json", (req, res) -> persistent(emf, (em) -> {
        ...
        get("/users/:name/inventories/:category", "application/json", (req, res) -> persistent(emf, (em) -> {
        ...
        post("/users/:name/inventories/:category", "application/json", (req, res) -> {
            ...
            Inventory saved = transactional(emf, (em) -> {
                ...
                Inventory i = saver.save(inv);
                user.getInventories().add(i);
